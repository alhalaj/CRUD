    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index.php" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Monitoring<small> LOHT </small></span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="assets-template/dist/img/user2-160x160.png" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <?php if ($_SESSION['level'] == 1 or $_SESSION['level'] == 2) : ?>
                            <li class="nav-item">
                                <a href="debitur.php" class="nav-link">
                        ...
                        <?php if ($_SESSION['level'] == 1 or $_SESSION['level'] == 3) : ?>
                            <!--<li class="nav-item">-->
                            <!--    <a href="loht.php" class="nav-link">-->
                            <!--        <i class="nav-icon fas fa-edit"></i>-->
                            <!--        <p>-->
                            <!--            Data LOHT-->
                            <!--        </p>-->
                        ...
                        <?php if ($_SESSION['level'] == 1 or $_SESSION['level'] == 3) : ?>
                            <!--<li class="nav-item">-->
                            <!--    <a href="hasil_lelang.php" class="nav-link">-->
                            <!--        <i class="nav-icon fas fa-edit"></i>-->
                            <!--        <p>-->
                            <!--            Hasil Lelang-->
                            <!--        </p>-->
                        ...
                        <?php if ($_SESSION['level'] == 1 or $_SESSION['level'] == 3) : ?>
                            <!--<li class="nav-item">-->
                            <!--    <a href="teaser.php" class="nav-link">-->
