                        ...
                        <div class="form-group col-6">
                            ...
                            <div class="form-group mb-3 col-2">
                                ...
                                <select name="legalitas" id="legalitas" class="form-control" required>
                                    <?php $legalitas     = $mahasiswa['legalitas']; ?>
                                    <option value="SHM" <?= $legalitas == 'SHM' ? 'selected' : null ?>>SHM</option>
                                    <option value="SHGB" <?= $legalitas == 'SHGB' ? 'selected' : null ?>>SHGB</option>
                                    <option value="SHMRS" <?= $legalitas == 'SHMRS' ? 'selected' : null ?>>SHMRS</option>
                                    <option value="SHP" <?= $legalitas == 'SHP' ? 'selected' : null ?>>SHP</option>
                                    <option value="SHGU" <?= $legalitas == 'SHGU' ? 'selected' : null ?>>SHGU</option>
                                    <option value="LAINNYA" <?= $legalitas == 'LAINNYA' ? 'selected' : null ?>>LAINNYA</option>
                                </select>
                            </div>
